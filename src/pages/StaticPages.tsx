...
export function TermsPage() {
  return (
    <PublicPage title="이용약관">
      ...
      <h2>제1조 (목적)</h2>
      <p>
        이 약관은 DeciDuel 서비스 운영자 Llimy1(이하 “운영자”)가 제공하는 음성 크기 대결
        서비스 “DeciDuel”(모바일 애플리케이션 및 관련 제반 서비스, 이하 “서비스”)의 이용과
      ...
      <ul>
        ...
        <li>
          서비스를 이용하여 얻은 정보를 운영자의 사전 동의 없이 복제, 유통, 조장하거나 영리
          목적으로 이용하는 행위
        </li>
        <li>
      ...
      <p>
        ...
        지적재산권은 운영자에 귀속됩니다. 회원이 서비스 내에서 직접 작성한 콘텐츠(닉네임, 다이어리
        코멘트 등)의 저작권은 해당 회원에게 있으며, 회원은 운영자가 서비스의 운영·홍보·개선을
