...
export function PrivacyPage() {
  return (
    <PublicPage title="개인정보처리방침">
      ...
      <p>
        서비스의 핵심 기능(음성 크기 측정·대결)을 위해 마이크 접근 권한이 필요합니다.{' '}
        <strong>
          운영자는 이용자의 음성을 녹음하거나 음성 파일·음성 데이터 자체를 서버로 전송·저장하지
          않습니다.
        </strong>{' '}
        기기에서 실시간으로 음량 수준을 측정해 숫자형 데시벨(dB) 값만 추출하며, 이 수치만이
        대결 결과·기록 산출 및 저장에 사용됩니다.
      </p>
